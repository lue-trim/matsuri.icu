<template>
    <div>
        ...
        <div class="container">
            ...
            <p>项目地址详见：</p>
            <p>前端（在原版基础上改的, 添加了一些方便的小功能）<a target="_blank" rel="noopener noreferrer" href="https://github.com/lue-trim/matsuri.icu">https://github.com/lue-trim/matsuri.icu</a></p>
            ...
            <p>5. 收入数据是按直播间实际打款金额(盲盒按实际消费金额计算)计算的, 没法精确统计礼物数量, 所以所有礼物的个数都显示成1</p>
            <p>6. 自动识别语音字幕并作为翻译man弹幕显示</p>
            <p>7. 其他体验优化: api支持在线切片和切弹幕(前端没做), 场次列表分页, 减少recaptcha重复验证, 弹幕正则搜索, 数据库和上舰记录查询</p>
            <p>以下是原说明..</p>
        </div>
        <div class="row">
            <div class="col-4">
        ...
        <div class="container">
            ...
            <p>如果有需要增加收录的也可以点<a target="_blank" rel="noopener noreferrer" href="https://add.matsuri.icu/">这里</a>或者通过上面的方式联系！</p>
            ...
            <br>要抓也就抓吧，也设置一下频率吧，一秒用IP池发100多个请求谁撑得住啊！
            <p>程序力非常弱可能一堆乱七八糟的情况也请见谅！</p>
            <p class="pt-3">其实一开始只是随手看到群里的大佬提出来：做一个统计直播弹幕的内容方便录播组剪辑打灯之类的吧！</p>
            <p>然后就这样愉快的做出来了，然后貌似还是半自动不太好用<s>以及一些奇奇怪怪的Bug</s>，干脆就一条龙服务吧！</p>
            <p>关于“观看人数“：数据是从弹幕发言、礼物、b站进入通知（xxx进入/关注/分享了直播间）的所有人数加在一起后以B站UID去重获得，真实的数据应该会更多不会更少wwww</p>
            <p>礼物是包括送礼和舰长哒！（是按照打折后的价格来哒）</p>
        </div>
    </div>
</template>
